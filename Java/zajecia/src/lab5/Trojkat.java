...
public class Trojkat extends Wielokat {
	...
	public Trojkat(int pole, int obwod, Color kolor, int wierzcholki, int boki, double a, double h) {
	...
	public Trojkat(int pole, int obwod, Color kolor, int wierzcholki, int boki) {
		super(pole, obwod, kolor, wierzcholki, boki);
		// TODO Auto-generated constructor stub
	}
